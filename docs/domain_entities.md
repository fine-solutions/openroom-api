...
### Создание корпуса
Корпус создаётся на основе плана помещений, загруженного в систему. При этом план помещений должен представлять из себя svg-документ и соответствовать [определённой структуре](/docs/unit_schema_definition.md).
